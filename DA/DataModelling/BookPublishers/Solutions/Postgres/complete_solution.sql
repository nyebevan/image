...
alter table if exists bookauthor
...
alter table if exists book
	drop constraint if exists fk_pub;
...
-- publisher
--===========================================
insert into publisher (name, contact)
